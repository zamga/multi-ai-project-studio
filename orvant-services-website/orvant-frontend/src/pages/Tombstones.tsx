  ...
  const transactions = [
    {
      ...
      outcome: 'Successful close with premium valuation',
      confidential: true,
      monogram: 'MA',
    },
    {
      ...
      outcome: 'Strategic fit achieved',
      confidential: true,
      monogram: 'MA',
    },
    {
      ...
      outcome: 'Liquidity restored, operations stabilized',
      confidential: true,
      monogram: 'RS',
    },
    {
      ...
      outcome: 'Extended runway, improved terms',
      confidential: true,
      monogram: 'RS',
    },
    {
      ...
      outcome: 'Successful market debut',
      confidential: true,
      monogram: 'PM',
    },
    {
      ...
      outcome: 'Oversubscribed offering',
      confidential: true,
      monogram: 'PM',
    },
    {
      ...
      outcome: 'Clean separation, value maximized',
      confidential: true,
      monogram: 'MA',
    },
    {
      ...
      outcome: 'Creditor alignment achieved',
      confidential: true,
      monogram: 'RS',
    },
  ]
